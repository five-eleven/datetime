...
(function (global) {
    ...
    TZDate.prototype = {
        ...
        _simpleAdd: function (obj, name, nextUnitName, upperBound,
            ...
            obj[name] += this[name]
            simpleSetFun(0);
            obj[nextUnitName] = Math.floor(obj[name] / upperBound);
            obj[name] = obj[name] % upperBound;
            obj[name] = obj[name] < 0 ? obj[name] + upperBound : obj[name];
            if (obj[nextUnitName] === 0) {
                simpleSetFun(obj[name]);
            } else {
                this.add(obj);
                return;
            }
            delete obj[name];
            delete obj[nextUnitName];
        },
